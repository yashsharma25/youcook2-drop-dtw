...
parser.add_argument('--dataset', type=str, default='YouCook2', choices=['COIN', 'CrossTask', 'YouCook2'], help="name of the dataset we are encoding")
...
parser.add_argument('--n_cls', type=int, default=2, help="Number of video of one class in a batch. Must divide batch_size")
...
class TrainModule(pl.LightningModule):
    def __init__(self, model, data, name=None):
        ...
        self.model = model
        self.data = data
        print("In Train modele data.type=", type(self.data))
...
def main():
    ...
    print("Here")
    trainer = pl.Trainer(accelerator="auto", callbacks=[checkpoint_callback, vis_callback],
                         max_epochs=args.epochs, logger=logger, log_every_n_steps=1)
